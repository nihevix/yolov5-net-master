    ...
    public partial class Form1 : Form
    {
        ...
        private async Task OutputRecordingAsync()
        {
            ...
            try
            {
                ...
                txtAzureStorageConnectionString.Text = $"Recording saved to local disk with the file name {outputPath}.";
                ...
                if (!string.IsNullOrWhiteSpace(azureStorageConnectionString))
                {
                    try
                    {
                        ...
                        txtAzureStorageConnectionString.Text = $"Recording saved to both local disk and Azure Blob Storage with the file name {outputPath}.";
                    }
                    catch (Exception ex)
                    {
                        txtAzureStorageConnectionString.Text = $"Recording saved to both local disk with the file name {outputPath} but cannot be saved on Azure Blob Storage.";
            ...
            {
                txtAzureStorageConnectionString.Text = "Recording cannot be saved.";
